...
function SimulasiMobil() {
  ...
  const [listPerluasan, setListPerluasan] = useState([
    ...
    {judul: "BANJIR, ANGIN TOPAN & BADAI", value: false},
    {judul: "GEMPA BUMI,LETUSAN GUNUNG BERAPI & TSUNAMI", value: false},
    {judul: "BENKEL RESMI", value: false},
    {judul: "DEREK & HOTLINE 24 JAM", value: false},
